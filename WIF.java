...
public class WIF {
    ...
    // Hash sha256 :: Input 9454a5235cf34e382d7e927eb5709dc4f4ed08eed177cb3f2d4ea359071962d7
    // WIF Key :: Output 5JwcVJQfQbzAfXnMYQXzLjzczGi22v8BvyyHkUBTmYwN7Z3Qswa
    ...
    // Hash sha256 :: Input 9454a5235cf34e382d7e927eb5709dc4f4ed08eed177cb3f2d4ea359071962d7
    // WIF Key :: Output L2C3duqSXBRKf4sBfcsn68mKqnL3ZTUjFGTSvryB9dxxBche5CNY
    public static String Private_to_WIF_compressed(String privateKeyHex) throws Exception {
        ...
        byte[] wifBytes = concat_3item(extendedKey,suffix , checksum);
        //System.out.println(wifBytes);
        String WIF_KEY = Base58.encode(wifBytes);
        return  WIF_KEY;
    }
    ...
    public static String random_key() {
        final int ENTROPY_LENGTH = 64;
        final int LOOP_TIME = 62000000; // 12วินาที
